...
Router.map(function () {
    this.route('home',
        {
            path: '/', layoutTemplate: 'layout', loadingTemplate: 'loading',
            waitOn: function () {
                return [
...
Router.onBeforeAction('loading', { only: ['home']});
Router.onBeforeAction(requireLogin, { only: ['competitionList', 'competitionDetails', 'addCompetition' , 'teamList' , 'addTeam', 'editTeam' , 'addPlayer', 'editPlayer', 'playerList' , 'dashboard']});